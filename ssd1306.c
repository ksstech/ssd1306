...
static void	ssd1306I2C_IO(u8_t * pBuf, u8_t Size) {
	int iRV ;
	if (Size == 1) {
...
int	ssd1306ConfigMode(rule_t * psR) {
	...
	IF_P(debugTRACK && ioB1GET(dbgMode), "ssd1306 ap0=%hhu ap1=%hhu P0=%lu P1=%lu P2=%lu\r\n",
											psR->actPar0[AI], psR->actPar1[AI], P0, P1, P2) ;
